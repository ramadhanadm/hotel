                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-lg-block bg-primary shadow-lg p-5 text-center">
                                <img src="assets/img/hotel.png" alt="logo" width="300">
                                <h3 class="text-white mt-4">Sistem Informasi Buku Tamu <br>Hotel Sarah Juli </h3>
                                <!-- <br> <small>Blangkejeren, Gayo Lues</small> -->
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="#"><?=date("l, d M Y - h:i:s")?> <br>Hotel Sarah Juli | 2023 - <?=date('Y') ?> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
